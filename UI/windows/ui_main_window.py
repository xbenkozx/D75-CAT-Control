...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bandAMeter = QProgressBar(self.widget_20)
        ...
        self.verticalLayout_15.addWidget(self.bandAMeter)
        ...
        self.bandAChannelLbl = QLabel(self.widget_22)
        ...
        self.verticalLayout_16.addWidget(self.bandAChannelLbl)
        ...
        self.bandAFreqText.setAlignment(Qt.AlignCenter)
        ...
        self.bandBMeter = QProgressBar(self.widget_13)
        ...
        self.verticalLayout_2.addWidget(self.bandBMeter)
        ...
        self.bandBChannelLbl = QLabel(self.widget_15)
        ...
        self.verticalLayout_11.addWidget(self.bandBChannelLbl)
        ...
        self.bandBFreqText.setAlignment(Qt.AlignCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"S-Meter", None))
